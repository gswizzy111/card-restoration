        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4 items-center min-h-[85vh]">
          ...
          <div className="-mt-8 md:-mt-10">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2">
              {["Insured shipping", "Photo updates", "5–8 day turnaround"].map((item) => (
          ...
          <div className="flex items-center justify-center lg:justify-end -mt-8 md:-mt-10">
            <div className="relative w-[120%] lg:w-[115%] xl:w-[120%] -mr-6 md:-mr-8">
