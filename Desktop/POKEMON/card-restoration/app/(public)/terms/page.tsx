    ...
    <div className="min-h-screen bg-white py-16">
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground">
          ...
          <section>
            <h2 className="text-2xl font-bold font-heading mt-8 mb-4">2. Service Tiers and Turnaround Times</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold font-heading mt-8 mb-4">3. Shipping and Loss in Transit</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm">
              ...
              <li>Any loss, theft, or destruction during shipment</li>
              <li>Any delay in delivery</li>
              <li>Damage caused by improper packing or packaging</li>
              <li>Damage to any protective materials or containers</li>
          ...
          <section>
            <h2 className="text-2xl font-bold font-heading mt-8 mb-4">4. Damage, Alteration, and Condition Changes</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm">
              <li>Become damaged, cracked, or broken during restoration</li>
              <li>Experience changes in color, finish, or appearance</li>
              <li>Be altered in any way by our restoration process</li>
              <li>Receive a lower grade than expected after restoration</li>
              <li>Be returned in different condition than submitted</li>
          ...
          <section>
            <h2 className="text-2xl font-bold font-heading mt-8 mb-4">5. Limited Liability and Disclaimer of Damages</h2>
            <p>
              <strong>
                TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE CARD DOC SHALL HAVE NO LIABILITY WHATSOEVER TO YOU FOR ANY LOSS,
                DAMAGE, ALTERATION, OR CHANGE TO YOUR CARD OR ANY ITEM SUBMITTED FOR SERVICES, WHETHER CAUSED BY OUR NEGLIGENCE OR OTHERWISE.
              </strong>
            </p>
            <p>
              Your sole and exclusive remedy for any claim is limited to a refund of the service fee paid. THE CARD DOC SHALL NOT BE
              LIABLE FOR:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-sm">
              <li>Damage to cards during restoration or handling</li>
            ...
            <p>
              IN NO EVENT SHALL OUR TOTAL LIABILITY EXCEED THE SERVICE FEE PAID BY YOU FOR THAT SPECIFIC ITEM, REGARDLESS OF THE ACTUAL
              VALUE OF THE CARD OR THE EXTENT OF DAMAGE.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              re-evaluation at full service rate. You will be charged the full service fee regardless of outcome.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold font-heading mt-8 mb-4">8. Payment Terms</h2>
            <p>
              Payment is due in full at the time of order submission. All fees are non-refundable and non-cancellable except as specifically
              stated in these Terms. All pricing is final regardless of outcome.
            </p>
            <p>
              Cancellations are only permitted before processing begins. If you request cancellation, you will be charged a non-refundable
          ...
          <section>
            <h2 className="text-2xl font-bold font-heading mt-8 mb-4">9. Discount Codes and Affiliate Codes</h2>
            <p>
              Any discount codes or affiliate codes are applied at checkout. Discounts are calculated on the service fee only and do not
              apply to shipping or other additional fees. The Card Doc reserves the right to modify, revoke, or cancel any discount codes
              at any time.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold font-heading mt-8 mb-4">11. Limitation of Liability</h2>
            <p>
              <strong>
                IN NO EVENT SHALL THE CARD DOC, ITS OWNERS, EMPLOYEES, AGENTS, OR AFFILIATES BE LIABLE TO YOU FOR ANY INDIRECT, INCIDENTAL,
                SPECIAL, PUNITIVE, CONSEQUENTIAL, OR EXEMPLARY DAMAGES OF ANY KIND, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
              </strong>
            </p>
            <p>
              This includes but is not limited to: loss of data, loss of money, loss of goodwill or reputation, costs of delay, lost
              profits, business interruption, emotional distress, or any intrinsic or sentimental value. This limitation applies regardless
              of cause, whether based on warranty, contract, tort, strict liability, or any other legal theory.
            </p>
            <p>
              Your maximum liability against The Card Doc is limited to the service fee paid for the specific item in question. You
              acknowledge this is a reasonable allocation of risk and agree it is the sole and exclusive remedy for any claim.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold font-heading mt-8 mb-4">12. Your Information and Authorization</h2>
            <p>
              By submitting items, you represent and warrant that:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-sm">
              <li>All information provided is current, truthful, and accurate</li>
              <li>You own or have authority to submit each item</li>
              <li>Each item is free and clear of liens or encumbrances</li>
              <li>Each item has not been doctored, altered, or counterfeited</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm">
              ...
              <li>Your submission of inauthentic, doctored, or altered items</li>
              <li>Your negligence or willful misconduct</li>
              <li>Any claim by a third party regarding items you submitted</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold font-heading mt-8 mb-4">16. Severability</h2>
            <p>
              If any provision of these Terms is found to be invalid or unenforceable, such provision shall be modified to the minimum
              extent necessary to make it valid, or if not possible, severed, and the remaining provisions shall remain in full force and effect.
            </p>
          </section>
